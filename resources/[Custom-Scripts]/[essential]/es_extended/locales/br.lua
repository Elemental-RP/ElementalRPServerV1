Locales['br'] = {
  ...
  ['weapon_carbinerifle_mk2'] = 'carbina rifle mk2',
  ['weapon_assaultrifle_mk2'] = 'assault shotgun mk2',
  ...
  ['component_holographic_sight'] = 'Mira Holografica',
  ['component_medium_scope'] = 'Mira Média',
  ['component_small_scope'] = 'Mira Pequena',
  ['component_large_scope'] = 'Mira Larga',
  ['component_flat_muzzle_brake'] = 'Flat Muzzle Brake',
  ['component_tactical_muzzle_brake'] = 'Tactical Muzzle Brake',
  ['component_fat_end_muzzle_brake'] = 'Fat End Muzzle Brake',
  ['component_precision_muzzle_brake'] = 'Precision Muzzle Brake',
  ['component_heavy_duty_muzzle_brake'] = 'Heavy Duty Muzzle Brake',
  ['component_slanted_muzzle_brake'] = 'Slanted Muzzle Brake',
  ['component_split_end_muzzle_brake'] = 'Split End Muzzle Brake',
  ['component_default_barrel'] = 'Barrel Default',
  ['component_heavy_barrel'] = 'Barrel Pesado',
  ['component_mounted_scope'] = 'Mira Montada',
  ['component_Squared_Muzzle_Brake'] = 'Squared Muzzle Brake',
  
   -- skins novas
  ['component_knuckle_skin_love'] = 'Skin Love',
  ['component_knuckle_skin_dollar'] = 'Skin Dollar',
  ['component_knuckle_skin_vagos'] = 'Skin Vagos',
  ['component_knuckle_skin_hate'] = 'Skin Hate',
  ['component_knuckle_skin_diamond'] = 'Skin Diamond',
  ['component_knuckle_skin_pimp'] = 'Skin Pimp',
  ['component_knuckle_skin_king'] = 'Skin King',
  ['component_knuckle_skin_ballas'] = 'Skin Ballas',
  ['component_switchblade_skin_variant_1'] = 'Skin Variant 1',
  ['component_switchblade_skin_variant_2'] = 'Skin Variant 2',
  ['component_skin_lowrider'] = 'Skin LowRider',
