...
Config.Weapons = {
	{
		...
		components = {
			...
			{ name = 'holographic_sight', label = _U('component_holographic_sight'), hash = GetHashKey('COMPONENT_AT_SIGHTS_SMG') },
			{ name = 'small_scope', label = _U('component_small_scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_MACRO_02_SMG_MK2') },
			{ name = 'medium_scope', label = _U('component_medium_scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_SMALL_SMG_MK2') },
			{ name = 'suppressor', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AT_PI_SUPP') },
			{ name = 'flat_muzzle_brake', label = _U('component_flat_muzzle_brake'), hash = GetHashKey('COMPONENT_AT_MUZZLE_01') },
			{ name = 'tactical_muzzle_brake', label = _U('component_tactical_muzzle_brake'), hash = GetHashKey('COMPONENT_AT_MUZZLE_02') },
			{ name = 'fat_end_muzzle_brake', label = _U('component_fat_end_muzzle_brake'), hash = GetHashKey('COMPONENT_AT_MUZZLE_03') },
			{ name = 'precision_muzzle_brake', label = _U('component_precision_muzzle_brake'), hash = GetHashKey('COMPONENT_AT_MUZZLE_04') },
			{ name = 'heavy_duty_muzzle_brake', label = _U('component_heavy_duty_muzzle_brake'), hash = GetHashKey('COMPONENT_AT_MUZZLE_05') },
			{ name = 'slanted_muzzle_brake', label = _U('component_slanted_muzzle_brake'), hash = GetHashKey('COMPONENT_AT_MUZZLE_06') },
			{ name = 'split_end_muzzle_brake', label = _U('component_split_end_muzzle_brake'), hash = GetHashKey('COMPONENT_AT_MUZZLE_07') },
			{ name = 'default_barrel', label = _U('component_default_barrel'), hash = GetHashKey('COMPONENT_AT_SB_BARREL_01') },
			{ name = 'heavy_barrel', label = _U('component_heavy_barrel'), hash = GetHashKey('COMPONENT_AT_SB_BARREL_02') }
		}
	},
	
	{
		...
		components = {
			...
			{ name = 'Flashlight', label = _U('component_Flashlight'), hash = GetHashKey('COMPONENT_AT_AR_FLSH') },
			{ name = 'Holographic_Sight', label = _U('component_Holographic_Sight'), hash = GetHashKey('COMPONENT_AT_SIGHTS') },
			{ name = 'Small_Scope', label = _U('component_Small_Scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_MACRO_02_MK2') },
			{ name = 'Medium_Scope', label = _U('component_Medium_Scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_SMALL_MK2') },
			{ name = 'Default_Barrel', label = _U('component_Default_Barrel'), hash = GetHashKey('COMPONENT_AT_BP_BARREL_01') },
			{ name = 'Heavy_Barrel', label = _U('component_Heavy_Barrel'), hash = GetHashKey('COMPONENT_AT_BP_BARREL_02') },
	...
	
	{
		...
		components = {
			...
			{ name = 'Flashlight', label = _U('component_Flashlight'), hash = GetHashKey('COMPONENT_AT_AR_FLSH') },
			{ name = 'Holographic_Sight', label = _U('component_Holographic_Sight'), hash = GetHashKey('COMPONENT_AT_SIGHTS') },
			{ name = 'Small_Scope', label = _U('component_Small_Scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_MACRO_MK2') },
			{ name = 'Large_Scope', label = _U('component_Large_Scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_MEDIUM_MK2') },
			{ name = 'Suppressor', label = _U('component_Suppressor'), hash = GetHashKey('COMPONENT_AT_AR_SUPP_02') },
			{ name = 'Flat_Muzzle_Brake', label = _U('component_Flat_Muzzle_Brake'), hash = GetHashKey('COMPONENT_AT_MUZZLE_01') },
			{ name = 'Flat_Muzzle_Brake', label = _U('component_Tactical_Muzzle_Brake'), hash = GetHashKey('COMPONENT_AT_MUZZLE_02') },
			{ name = 'Tactical_Muzzle_Brake', label = _U('component_Fat_End_Muzzle_Brake'), hash = GetHashKey('COMPONENT_AT_MUZZLE_03') },
			{ name = 'Fat_End_Muzzle_Brake', label = _U('component_Precision_Muzzle_Brake'), hash = GetHashKey('COMPONENT_AT_MUZZLE_04') },
			{ name = 'Precision_Muzzle_Brake', label = _U('component_Heavy_Duty_Muzzle_Brake'), hash = GetHashKey('COMPONENT_AT_MUZZLE_05') },
			{ name = 'Heavy_Duty_Muzzle_Brake', label = _U('component_Slanted_Muzzle_Brake'), hash = GetHashKey('COMPONENT_AT_MUZZLE_06') },
			{ name = 'Slanted_Muzzle_Brake', label = _U('component_Split_End_Muzzle_Brake'), hash = GetHashKey('COMPONENT_AT_MUZZLE_07') },
			{ name = 'clip_Grip', label = _U('component_Grip'), hash = GetHashKey('COMPONENT_AT_AR_AFGRIP_02') },
			{ name = 'Default_Barrel', label = _U('component_Default_Barrel'), hash = GetHashKey('COMPONENT_AT_SC_BARREL_01') },
			{ name = 'Heavy_Barrel', label = _U('component_Heavy_Barrel'), hash = GetHashKey('COMPONENT_AT_SC_BARREL_02') }
		}
	},
	
	{
		...
		components = {
			...
			{ name = 'slanted_muzzle_brake', label = _U('component_slanted_muzzle_brake'), hash = GetHashKey('COMPONENT_AT_MUZZLE_06') },
			{ name = 'split_end_muzzle_brake', label = _U('component_split_end_muzzle_brake'), hash = GetHashKey('COMPONENT_AT_MUZZLE_07') },
			{ name = 'default_barrel', label = _U('component_default_barrel'), hash = GetHashKey('COMPONENT_AT_AR_BARREL_01') },
			{ name = 'heavy_barrel', label = _U('component_heavy_barrel'), hash = GetHashKey('COMPONENT_AT_AR_BARREL_02') }
		}
	},
	
	{
		...
		components = {
			...
			{ name = 'flashlight', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_AT_AR_FLSH') },
			{ name = 'grip', label = _U('component_grip'), hash = GetHashKey('COMPONENT_AT_AR_AFGRIP_02') },
			{ name = 'default_clip', label = _U('component_default_clip'), hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MK2_CLIP_01') },
			{ name = 'holographic_sight', label = _U('component_holographic_sight'), hash = GetHashKey('COMPONENT_AT_SIGHTS') },
			{ name = 'small_scope', label = _U('component_small_scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_MACRO_MK2') },
			{ name = 'large_scope', label = _U('component_large_scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_MEDIUM_MK2') },
			{ name = 'suppressor', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AT_AR_SUPP_02') },
	...
	
	{
		...
		components = {
			...
			{ name = 'zoom_scope', label = _U('component_zoom_scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_LARGE_MK2') },
			{ name = 'advanced_scope', label = _U('component_advanced_scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_MAX') },
			{ name = 'night_vision_scope', label = _U('component_night_vision_scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_NV') },
			{ name = 'thermal_scope', label = _U('component_thermal_scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_THERMAL') },
			{ name = 'suppressor', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AT_SR_SUPP_03') },
			{ name = 'squared_muzzle_brake', label = _U('component_squared_muzzle_brake'), hash = GetHashKey('COMPONENT_AT_MUZZLE_08') },
			{ name = 'bell_end_muzzle_brake', label = _U('component_bell_end_muzzle_brake'), hash = GetHashKey('COMPONENT_AT_MUZZLE_09') },
			{ name = 'default_barrel', label = _U('component_default_barrel'), hash = GetHashKey('COMPONENT_AT_SR_BARREL_01') },
			{ name = 'heavy_barrel', label = _U('component_heavy_barrel'), hash = GetHashKey('COMPONENT_AT_SR_BARREL_02') }
		}
	},
	...
	
	{
		...
		components = {
			...
			{ name = 'mounted_scope', label = _U('component_mounted_scope'), hash = GetHashKey('COMPONENT_AT_PI_RAIL') },
...

	{
		...
		components = {
		    ...
		    { name = 'Mounted_Scope', label = _U('component_Mounted_Scope'), hash = GetHashKey('COMPONENT_AT_PI_RAIL_02') },
		    { name = 'Suppressor', label = _U('component_Suppressor'), hash = GetHashKey('COMPONENT_AT_PI_SUPP_02') },
		    { name = 'Compensator', label = _U('component_Compensator'), hash = GetHashKey('COMPONENT_AT_PI_COMP_02') }
		}
	},
	
	{name = 'WEAPON_PUMPSHOTGUN_MK2', label = _U('weapon_pumpshotgun_mk2'), components = {}, tints = Config.DefaultWeaponTints, ammo = {label = _U('ammo_shells'), hash = GetHashKey('AMMO_SHOTGUN')}},
	{name = 'WEAPON_COMBATMG_MK2', label = _U('weapon_combatmg_mk2'), components = {}, tints = Config.DefaultWeaponTints, ammo = {label = _U('ammo_rounds'), hash = GetHashKey('AMMO_MG')}},
	{name = 'WEAPON_REVOLVER_MK2', label = _U('weapon_revolver_mk2'), components = {}, tints = Config.DefaultWeaponTints, ammo = {label = _U('ammo_rounds'), hash = GetHashKey('AMMO_PISTOL')}},
	...
	{name = 'GADGET_PARACHUTE', label = _U('gadget_parachute'), components = {}},
	{
		...
		components = {
			{ name = 'knuckle_skin_love', label = _U('component_knuckle_skin_love'), hash = GetHashKey('COMPONENT_KNUCKLE_VARMOD_LOVE') },
			{ name = 'knuckle_skin_dollar', label = _U('component_knuckle_skin_dollar'), hash = GetHashKey('COMPONENT_KNUCKLE_VARMOD_DOLLAR') },
			{ name = 'knuckle_skin_vagos', label = _U('component_knuckle_skin_vagos'), hash = GetHashKey('COMPONENT_KNUCKLE_VARMOD_VAGOS') },
			{ name = 'knuckle_skin_hate', label = _U('component_knuckle_skin_hate'), hash = GetHashKey('COMPONENT_KNUCKLE_VARMOD_HATE') },
			{ name = 'knuckle_skin_diamond', label = _U('component_knuckle_skin_diamond'), hash = GetHashKey('COMPONENT_KNUCKLE_VARMOD_DIAMOND') },
			{ name = 'knuckle_skin_pimp', label = _U('component_knuckle_skin_pimp'), hash = GetHashKey('COMPONENT_KNUCKLE_VARMOD_PIMP') },
			{ name = 'knuckle_skin_king', label = _U('component_knuckle_skin_king'), hash = GetHashKey('COMPONENT_KNUCKLE_VARMOD_KING') },
			{ name = 'knuckle_skin_ballas', label = _U('component_knuckle_skin_ballas'), hash = GetHashKey('COMPONENT_KNUCKLE_VARMOD_BALLAS') }
		}
	},
	...
	{name = 'WEAPON_MACHETE', label = _U('weapon_machete'), components = {}},
	{
		...
		components = {			
			{ name = 'switchblade_skin_variant_1', label = _U('component_switchblade_skin_variant_1'), hash = GetHashKey('COMPONENT_SWITCHBLADE_VARMOD_VAR1') },
			{ name = 'switchblade_skin_variant_2', label = _U('component_switchblade_skin_variant_2'), hash = GetHashKey('COMPONENT_SWITCHBLADE_VARMOD_VAR2') }
		}
	},
