...
Config.Menus = {
	...
	modTransmission = {
		...
		parent = 'upgrades',
		modType = 13,
		price = {13.95, 20.93, 36.51}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {3.72, 7.44, 14.88, 19.77, 29.2}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {39.77, 41.28, 65.00, 84.00, 110.00, 140.00}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
