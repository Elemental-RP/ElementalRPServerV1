Config = {
    ...
    Items = {
        ["drinks"] = {
            ...
            {label = "Fanta", item = "fanta", price = 2},
            {label = "Água", item = "water", price = 1},
        },
        ["snacks"] = {
            {label = "Café", item = "coffe", price = 1},
            {label = "Batatas Fritas", item = "chips", price = 5},
            {label = "Pão", item = "bread", price = 1},
        },
        ["readymeal"] = {
            {label = "Pizza", item = "pizza", price = 9},
            {label = "Hamburger", item = "hamburger", price = 5},
        },
        ["diverse"] = {
            {label = "Cigarro", item = "cigarett", price = 6},
            {label = "Isqueiro", item = "lighter", price = 10},
            {label = "Telemóvel", item = "phone", price = 900},
            {label = "Bloco de Notas", item = "notepad", price = 15},
            {label = "Sacos", item = "drugbags", price = 10},
            {label = "Balança", item = "hqscale", price = 3500},
            {label = "Filtro", item = "rolpaper", price = 18},
            {label = "USB-C Branca", item = "cokeburn", price = 31100},
            {label = "USB-C Azul", item = "methburn", price = 3800},
            {label = "USB-C Verde", item = "weedburn", price = 3500},
            {label = "Binoculos", item = "binoculars", price = 450},
            {label = "Rádio", item = "radio", price = 500},
            {label = "LockPick", item = "lockpick", price = 1350}
        },
    },
}
