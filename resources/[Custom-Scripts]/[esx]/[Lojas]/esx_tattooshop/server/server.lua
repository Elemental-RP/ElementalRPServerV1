...
AddEventHandler("tattoos:save", function(tattoosList, price, value)
	...
	if(xPlayer.getMoney() >= price) then
		...
		TriggerClientEvent("esx:showNotification", _source, "~g~Acabaste de comprar uma tatuagem.")
	else
		TriggerClientEvent("esx:showNotification", _source, "~r~Não tens dinheiro suficiente.")
	end
end)
