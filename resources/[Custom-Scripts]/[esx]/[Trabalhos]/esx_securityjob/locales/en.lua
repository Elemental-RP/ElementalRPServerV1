Locales['en'] = {
	...
	['meet_ls']					= 'go pickup the money around the map',
	['meet_bc']					= 'go pickup the money around the map',
	['meet_del']				= 'go pickup the money around the map',
	['return_depot']			= 'return to the depot.',
	['blip_job']				= 'Prossegur',
	['blip_delivery']			= 'Prossegur : Entrega',
	['blip_goal']				= 'Prossegur : Ponto de Entrega',
	['blip_depot']				= 'Prossegur : depósito',
	['not_delivery']			= 'Nao entregue',
}