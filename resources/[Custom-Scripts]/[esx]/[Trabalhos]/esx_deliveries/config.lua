...
-- Locales
Config.Locales = {
	["delivery_not_available"] = "Este modelo está ~r~Indisponível~w~, usa a ~g~mota~w~ ou a ~g~van~w~.",
	["start_delivery"] = "Pressiona ~INPUT_CONTEXT~ para iniciar o trabalho de entrega, precisas de pagar o depósito seguro por ~g~€",
	["safe_deposit_received"] = "O depósito seguro foi removido da tua conta bancária",
	["safe_deposit_returned"] = "O depósito seguro retornou para a tua conta bancária agora",
	["safe_deposit_withheld"] = "Missão ~r~falhou~w~, o depósito seguro foi ~r~detido~w~.",
	["delivery_point_reward"] = "Missão concluída, recebeste ~g~€",
	["get_back_in_vehicle"] = "Retira o teu ~y~veículo~s~",
	["remove_goods"] = "Pressiona ~INPUT_CONTEXT~ para retirar os ~y~bens~s~ do carro",
	["remove_goods_subtext"] = "Deixa o teu carro e retira os teus ~y~bens~w~",
	["drive_next_point"] = "Dirija o carro para o próximo ~y~destino~w~",
	["deliver_inside_shop"] = "Leve os ~y~bens~w~ para o destino",
	["get_back_to_deliveryhub"] = "Voltar ao centro de entregas e devolver o carro",
	["delivery_vehicle_returned"] = "O teu carro foi devolvido",
	["finish_job"] = "Status da missão: ~g~",
	["end_delivery"] = "Pressiona ~INPUT_CONTEXT~ para encerrar a missão, senta-te no carro ou não receberás o depósito seguro",
	["blip_name"] = "Hub de entrega",
	["dst_blip"] = "Entrega",
	["delivery_end"] = "Fim da entrega",
	["delivery_failed"] = "Perdeste o cofre porque o teu carro estragou-se ou perdes-te-o",
	["delivery_finish"] = "Terminas a missão de entregas",
	["delivery_start"] = "Entrega",
	["delivery_tips"] = "Dirija o carro com segurança até o destino e entregue os ~y~bens~s~",
