...
AddEventHandler('esx_mechanicjob:startHarvest', function()
	...
	xPlayer.showNotification(_U('recovery_gas_can'))
	Harvest(source)
end)
...
AddEventHandler('esx_mechanicjob:startHarvest2', function()
	...
	xPlayer.showNotification(_U('recovery_repair_tools'))
	Harvest2(_source)
end)
...
AddEventHandler('esx_mechanicjob:startHarvest3', function()
	...
	xPlayer.showNotification(_U('recovery_body_tools'))
	Harvest3(_source)
end)
...
AddEventHandler('esx_mechanicjob:startCraft', function()
	...
	xPlayer.showNotification(_U('assembling_blowtorch'))
	Craft(_source)
end)
...
AddEventHandler('esx_mechanicjob:startCraft2', function()
	...
	xPlayer.showNotification(_U('assembling_repair_kit'))
	Craft2(_source)
end)
...
AddEventHandler('esx_mechanicjob:startCraft3', function()
	...
	xPlayer.showNotification(_U('assembling_body_kit'))
	Craft3(_source)
end)
...
AddEventHandler('esx_mechanicjob:onNPCJobMissionCompleted', function()
	...
	xPlayer.showNotification(_U('your_comp_earned').. total)
end)
