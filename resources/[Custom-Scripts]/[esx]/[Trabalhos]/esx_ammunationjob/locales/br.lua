Locales['br'] = {
  ...
  ['armory_owned'] = 'já tens',
  ['armory_free'] = 'grátis',
  ['armory_item'] = '$%s',
  ['armory_weapontitle'] = 'Armário - Comprar Arma',
  ['armory_componenttitle'] = 'Armário - Acessórios de armas',
  ['armory_bought'] = 'compraste uma ~y~%s~s~ por ~r~$%s~s~',
  ['armory_money'] = 'não podes pagar essa arma',
  ['armory_hascomponent'] = 'tens essa attatchment equipada!',
  ['get_weapon_menu'] = 'Armário - Retirar Arma',
  ['put_weapon_menu'] = 'Armário - Guardar Arma',
  ...
  ['fine'] = 'Multa',
  ['jail'] = 'Prender',
  ['jail_menu_info'] = 'Jail Info',
  ['unpaid_bills'] = 'Ver multas',
  ['license_check'] = 'Ver Liçensas',
  ...
  ['being_searched'] = 'estás a ser ~y~revistado~s~ por um ~b~Ammunation~s~',
  -- Vehicle interaction
  ...
  -- Notifications
  ['alert_ammu'] = 'Alerta da Ammunation',
  ['phone_ammu'] = 'ammu',
}
