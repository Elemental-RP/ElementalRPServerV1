...
TriggerEvent('es:addGroupCommand', 'screfresh', 'admin', function(source, args, user)
	...
	TriggerClientEvent('chat:addMessage', source, { args = { '^1Elemental Roleplay', 'Não tens permissão para dar refresh.' } })
end, {help = "Da refresh a scoreboard."})
...
TriggerEvent('es:addGroupCommand', 'sctoggle', 'admin', function(source, args, user)
	...
	TriggerClientEvent('chat:addMessage', source, { args = { '^1Elemental Roleplay', 'Não tens permissão para usar este comando.' } })
end, {help = "Desliga a scoreboard."})
