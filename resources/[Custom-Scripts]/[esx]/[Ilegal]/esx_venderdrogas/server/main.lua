...
AddEventHandler('sellDrugs', function()
	...
	TriggerClientEvent('esx:showNotification', _source, _U('you_have_sold') .. '~b~'.. x ..'~w~ de '.. drugType ..' por ' .. blackMoney .. '€')
end)
...
AddEventHandler('drugsInProgress', function(street1, street2, sex)
	...
	TriggerClientEvent("outlawNotify", -1, "~r~Vendedor de drogas por ~w~"..sex.." ~r~entre ~w~"..street1.."~r~ a ~w~"..street2)
end)
...
AddEventHandler('drugsInProgressS1', function(street1, sex)
	...
	TriggerClientEvent("outlawNotify", -1, "~r~Vendas de drogas através de ~w~"..sex.." ~r~na rua ~w~"..street1)
end)
