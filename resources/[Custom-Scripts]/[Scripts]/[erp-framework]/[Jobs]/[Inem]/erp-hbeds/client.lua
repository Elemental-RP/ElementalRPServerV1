		...
		if objects.object ~= nil and objects.ObjectVertX ~= nil and objects.ObjectVertY ~= nil and objects.ObjectVertZ ~= nil and objects.OjbectDir ~= nil and objects.isBed ~= nil then
			...
			if GetDistanceBetweenCoords(objectcoords.x, objectcoords.y, objectcoords.z,getPlayerCoords) < 1.8 and not using then
				if objects.isBed == true then
					DrawText3Ds(objectcoords.x, objectcoords.y, objectcoords.z+0.30, "~g~E~w~ para te deitares de "..animText)
					DrawText3Ds(objectcoords.x, objectcoords.y, objectcoords.z+0.20, "Clica nas setas da ~g~direita e esquerda ~w~para Alternar entre o estômago/costas")
					...
					DrawText3Ds(objectcoords.x, objectcoords.y, objectcoords.z+0.30, " ~g~G~w~ para sentar")
			...
			if using == true then
				Draw2DText("~g~F~w~ para levantar!",0,1,0.5,0.92,0.6,255,255,255,255)
