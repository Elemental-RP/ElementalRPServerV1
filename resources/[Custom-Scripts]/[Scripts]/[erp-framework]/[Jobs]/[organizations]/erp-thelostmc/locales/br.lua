Locales['br'] = {
  ...
  ['being_searched'] = 'estás a ser ~y~revistado~s~ por um ~b~The Lost MC~s~',
  -- Traffic interaction
  ...
  ['thelostmc_stock'] = 'Stock da The Lost MC',
  -- Misc
  ...
  -- Notifications
  ['alert_thelostmc'] = 'Alerta da The Lost MC',
  ['phone_thelostmc'] = 'The Lost MC',
}
