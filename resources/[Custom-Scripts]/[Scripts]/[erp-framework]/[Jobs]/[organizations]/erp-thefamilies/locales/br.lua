Locales['br'] = {
  ...
  ['being_searched'] = 'estás a ser ~y~revistado~s~ por um ~b~The Families~s~',
  -- Traffic interaction
  ...
  ['thefamilies_stock'] = 'Stock da The Families',
  -- Misc
  ...
  -- Notifications
  ['alert_thefamilies'] = 'Alerta da The Families',
  ['phone_thefamilies'] = 'The Families',
}
