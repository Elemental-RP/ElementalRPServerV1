Locales['br'] = {
  ...
  ['being_searched'] = 'estás a ser ~y~revistado~s~ por um ~b~Los Santos Vagos~s~',
  -- Traffic interaction
  ...
  ['lsvagos_stock'] = 'Stock da The Families',
  -- Misc
  ...
  -- Notifications
  ['alert_lsvagos'] = 'Alerta da Los Santos Vaogs',
  ['phone_lsvagos'] = 'Los Santos Vagos',
}
