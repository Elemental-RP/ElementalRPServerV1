...
-- You can disable the Ragdoll keybinding here.
	RagdollEnabled = true,
	RagdollKeybind = 246, -- Get the button number here https://docs.fivem.net/game-references/controls/
...
Config.Languages = {
  ['en'] = {
        ...
        ['cancelemoteinfo'] = "~r~X~w~ Cancela o emote atual",
        ['walkingstyles'] = "Modo de Andar",
        ...
        ['shareemotes'] = "👫 Emotes Partilhados",
        ...
        ['doyouwanna'] = "~y~H~w~ para aceitar, ~r~L~w~ para recusar (~g~",
