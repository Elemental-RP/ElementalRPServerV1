...
DP.Dances = {
   ...
   ["spiderman"] = {"anim@amb@nightclub@lazlow@hi_podium@", "danceidle_hi_17_spiderman_laz", "Spider Man", AnimationOptions =
   {
       EmoteLoop = true,
   }},
...
DP.Emotes = {
   ...
   ["cop3"] = {"amb@world_human_cop_idles@male@idle_a", "idle_a", "Cop 3", AnimationOptions =
   {
       EmoteLoop = true,
	   EmoteMoving = true,
   }},
