...
RegisterNUICallback('escape', function(data, cb)
    ...
    TriggerEvent("erp-notepad:CloseNotepad")
end)
...
RegisterNetEvent("erp-notepad:OpenNotepadGui")
AddEventHandler("erp-notepad:OpenNotepadGui", function()
    if not isUiOpen then
        openGui()
    end
end)

RegisterNetEvent("erp-notepad:CloseNotepad")
AddEventHandler("erp-notepad:CloseNotepad", function()
    SendNUIMessage({
        action = 'closeNotepad'
    })
...
RegisterNetEvent('erp-notepad:note')
AddEventHandler('erp-notepad:note', function()
    ...
    if ( DoesEntityExist( player ) and not IsEntityDead( player )) then 
        ...
        if ( IsEntityPlayingAnim( player, ad, "base", 3 ) ) then 
            ...
            AttachEntityToEntity(prop, player, GetPedBoneIndex(player, 18905), 0.1, 0.02, 0.05, 10.0, 0.0, 0.0, true, true, false, true, 1, true) -- erp-notepadpad
...
RegisterNetEvent('erp-notepad:updateNotes')
AddEventHandler('erp-notepad:updateNotes', function(serverNotesPassed)
