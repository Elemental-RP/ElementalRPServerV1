...
AddEventHandler(
  ...
  function(xPlayer)
    PlayerData = xPlayer
    TriggerServerEvent("erp-inventoryhud_trunk:getOwnedVehicule")
...
RegisterNetEvent("erp-inventoryhud_trunk:setOwnedVehicule")
AddEventHandler(
  "erp-inventoryhud_trunk:setOwnedVehicule",
  function(vehicle)
            ...
            if locked == 1 or class == 15 or class == 16 or class == 14 then
              ...
              if globalplate ~= nil or globalplate ~= "" or globalplate ~= " " then
                ...
                exports['mythic_progbar']:Progress({
                  name = "opentrunkprogbar",
                  duration = 1500,
                  label = 'A Abrir mala do carro',
                  useWhileDead = false,
                  canCancel = true,
                  controlDisables = {
                  ...
                  animation = {
                    ...
                    anim = "bag_handler_close_trunk_walk_left",
                    flags = 49,
                  }
                }, function(cancelled)
...
function OpenCoffreInventoryMenu(plate, max, myVeh)
  ESX.TriggerServerCallback(
    ...
    function(inventory)
      ...
      TriggerEvent("erp-inventoryhud:openTrunkInventory", data, inventory.blackMoney, inventory.items, inventory.weapons)
    end,
    plate
  )
end
