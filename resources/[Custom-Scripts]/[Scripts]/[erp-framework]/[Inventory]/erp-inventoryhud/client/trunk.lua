...
RegisterNetEvent("erp-inventoryhud:openTrunkInventory")
AddEventHandler(
    "erp-inventoryhud:openTrunkInventory",
...
RegisterNetEvent("erp-inventoryhud:refreshTrunkInventory")
AddEventHandler(
    "erp-inventoryhud:refreshTrunkInventory",
    function(data, blackMoney, inventory, weapons)
        setTrunkInventoryData(data, blackMoney, inventory, weapons)
    end
)
