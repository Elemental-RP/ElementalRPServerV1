...
ESX.RegisterServerCallback('erp-Tattoos:GetPlayerTattoos', function(source, cb)
...
ESX.RegisterServerCallback('erp-Tattoos:PurchaseTattoo', function(source, cb, tattooList, price, tattoo, tattooName)
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('erp-Tattoos:RemoveTattoo')
AddEventHandler('erp-Tattoos:RemoveTattoo', function (tattooList)
	local xPlayer = ESX.GetPlayerFromId(source)
