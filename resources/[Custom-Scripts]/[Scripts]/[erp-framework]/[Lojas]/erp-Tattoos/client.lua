...
AddEventHandler('skinchanger:modelLoaded', function()
	ESX.TriggerServerCallback('erp-Tattoos:GetPlayerTattoos', function(tattooList)
		if tattooList then
...
function BuyTattoo(collection, name, label, price)
	ESX.TriggerServerCallback('erp-Tattoos:PurchaseTattoo', function(success)
		if success then
...
function RemoveTattoo(name, label)
	...
	TriggerServerEvent("erp-Tattoos:RemoveTattoo", currentTattoos)
