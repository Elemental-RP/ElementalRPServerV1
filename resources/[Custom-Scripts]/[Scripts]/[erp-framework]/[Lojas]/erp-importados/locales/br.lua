Locales['br'] = {
  ...
  ['rent_vehicle']            = 'Importados - Veículos para alugar',
  ...
  ['generic_shopitem']        = '$%s',
  ['vehicle_dealer']          = 'Veículos - Importados',
  ...
  ['dealership_stock']        = 'estoque dos Importados',
  ['amount']                  = 'montante',
  ['quantity_invalid']        = 'quantidade inválida',
  ['inventory']               = 'Inventário',
  ['dealership']              = 'Importados',
