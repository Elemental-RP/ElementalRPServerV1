...
ESX.RegisterServerCallback('loaf_housing:getPlayerDressing', function(source, cb)
...
ESX.RegisterServerCallback('loaf_housing:getPlayerOutfit', function(source, cb, num)
	local xPlayer  = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('loaf_housing:removeOutfit')
AddEventHandler('loaf_housing:removeOutfit', function(label)
	local xPlayer = ESX.GetPlayerFromId(source)
