...
Config = {
    ...
    Furniture = {
        ['Categories'] = {
            ...
            {'electronics', 'Eletrónicas'},
            {'Plants', 'Plantas'},
            {'sofa', 'Sofas'},
            {'bed', 'Camas'},
            {'CashGoldJewels', 'Joalheria'},
            {'Drugs', 'Drugas'},
            {'FoodandDrinks','Bebidas Alimentos'},
            {'lights', 'Luzes'},
            {'kitchen', 'Cozinha'},
            {'accessory', 'Diversos'}
        },
...
Strings = {
    ['Press_E'] = 'Pressiona ~INPUT_CONTEXT~ para %s',
    ['Furniture_Categories'] = 'Categorias',
    ['Manage_House'] = 'Gerenciar a casa',
    ['Buy_House'] = 'comprar casa #%s',
    ['Knock_House'] = 'bater á porta',
    ['Your_House'] = 'A tua casa',
    ['Buyable_House'] = 'Casa Comprável',
    ['Player_House'] = 'Casa do jogador',
    ['Storage'] = 'acessar ao armazenamento',
    ['Sell_House'] = 'Vender por $%s',
    ['Enter_House'] = 'Entrar na casa',
    ['Sell_Confirm'] = 'Vender casa por $%s?',
    ['yes'] = 'Sim',
    ['no'] = 'Não',
    ['Sold_House'] = 'Tu vendeste a tua casa por $%s',
    ['Must_Sell'] = 'Só podes ter uma casa. Vende a tua casa se quiseres comprar esta.',
    ['Buy_House_Confirm'] = 'Comprar casa #%s por $%s?',
    ['Manage_Door'] = 'Gerenciar porta',
    ['Accept'] = 'Aceitar alguem que entre',
    ['Exit'] = 'Sair da casa',
    ['Noone_Home'] = 'Parece que ninguem está em casa!',
    ['Someone_Knocked'] = 'Alguem tocou à campainha. Vai até à porta e deixa-os entrar!',
    ['Let_In'] = 'Deixar alguém entrar',
    ['Accept_Player'] = 'Deixar %s entrar?',
    ['Waiting_Owner'] = 'Esperando que o dono da casa te dê permissão para entrares.',
    ['Buy_Furniture'] = 'entrar no IKEA',
    ['Buying_Furniture'] = '~INPUT_FRONTEND_LEFT~ ~INPUT_FRONTEND_RIGHT~ pesquisar\n~INPUT_CELLPHONE_DOWN~ ~INPUT_CELLPHONE_UP~ mudar de categoria (%s)\n~INPUT_FRONTEND_RDOWN~ comprar %s por $%s\n~INPUT_MOVE_UP_ONLY~ ~INPUT_MOVE_DOWN_ONLY~ ~INPUT_VEH_CINEMATIC_UP_ONLY~ ~INPUT_VEH_CINEMATIC_DOWN_ONLY~ ajustar camera\n~INPUT_MOVE_LEFT_ONLY~ ~INPUT_MOVE_RIGHT_ONLY~ rodar\n\n~INPUT_FRONTEND_RRIGHT~ sair',
    ['Confirm_Purchase'] = 'Comprar %s por $%s?',
    ['no_money'] = "Tu não tens dinheiro suficiente.",
    ['Bought_Furniture'] = 'Compras-te 1x %s por $%s',
    ['Furnish'] = 'Decora a tua casa',
    ['Store_Garage'] = 'Carrega ~INPUT_CONTEXT~ para guardares o veiculo',
    ['Re_Furnish'] = 'Remover decoração aplicada',
    ['Remove'] = 'Remover %s (#%s)',
    ['Amount'] = 'Quantos?',
    ['Player_Inventory'] = 'O teu inventário',
    ['House_Inventory'] = 'Inventário',
    ['Invalid_Amount'] = 'Valor inválido. Por favor coloca um número.',
    ['Store'] = 'Guardar',
    ['Withdraw'] = 'Retirar',
    ['Storage_Title'] = 'Armazenamento',
    ['You_Stored'] = 'Tu armazenas-te %sx %s',
    ['You_Withdrew'] = 'Tu retiras-te %sx %s',
    ['Not_Enough'] = 'Tu não tens objetos suficientes!',
    ['Not_Enough_House'] = 'Não tens tantos objetos no teu armazenamento!',
    ['Weapons'] = 'Armas',
    ['Items'] = 'Itens',
    ['No_Weapon'] = 'Não tens essa arma contigo!',
    ['bullets'] = 'Balas',
    ['Rotation'] = 'Rotação',
    ['Guests'] = 'Os teus convidados irão ter de sair da tua casa para efetuares esta ação.',
    ['Garage'] = 'Entrar na garagem!',
    ['No_Spawn'] = 'Não foi possivel encontrar um spawnpoint para a tua casa!',
    ['Host_Left'] = 'O dono da casa saiu da cidade, então foste removido.',
    ['No_Money'] = 'Não tens dinheiro suficiente',
    ['Available_House'] = 'Propriedades Disponiveis',
    ['Furnishing'] = '~INPUT_CELLPHONE_LEFT~ ~INPUT_CELLPHONE_RIGHT~ ~INPUT_CELLPHONE_DOWN~ ~INPUT_CELLPHONE_UP~ mover\n~INPUT_VEH_CINEMATIC_UP_ONLY~ ~INPUT_VEH_CINEMATIC_DOWN_ONLY~ altura\n~INPUT_ATTACK~ ~INPUT_AIM~ rodar\n~INPUT_DETONATE~ Colocar no chão\n~INPUT_FRONTEND_ENDSCREEN_ACCEPT~ colocar\n~INPUT_FRONTEND_CANCEL~ cancelar'
}
