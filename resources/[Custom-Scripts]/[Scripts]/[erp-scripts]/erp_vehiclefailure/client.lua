...
RegisterNetEvent('erp_vehiclefailure:repair')
AddEventHandler('erp_vehiclefailure:repair', function()
...
RegisterNetEvent('erp_vehiclefailure:notAllowed')
AddEventHandler('erp_vehiclefailure:notAllowed', function()
