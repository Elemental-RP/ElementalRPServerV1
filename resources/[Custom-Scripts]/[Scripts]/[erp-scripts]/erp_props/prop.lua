...
local dropkey 	= 217 -- Key to drop/get the props
...
attachPropList = {
  ...
  {["model"] = 'prop_cs_trolley_01',				["name"] = "trolley", 		["bone"] = 28422, ["x"] = 0.0,	["y"] = -0.6,	["z"] = -0.8,	["xR"] = -180.0,["yR"] = -165.0,["zR"] = 90.0, 	["anim"] = 'hold' }, -- Done
	...
	{["model"] = 'xm_prop_x17_bag_med_01a',				["name"] = "minem", 		["bone"] = 28422, ["x"] = 0.4,	["y"] = -0.1,	["z"] = -0.1,	["xR"] = 315.0,	["yR"] = 298.0, ["zR"] = 0.0, 	["anim"] = 'pick' }, -- Done
...
AddEventHandler('inrp_propsystem:attachProp', function(attachModelSent,boneNumberSent,x,y,z,xR,yR,zR)
	exports['mythic_notify']:SendAlert('inform', 'Clica [CAPS] para pegar ou dropar e Digita /r para remover')
    closestEntity = 0
    holdingPackage = true
