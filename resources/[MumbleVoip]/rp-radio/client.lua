...
Radio.Labels = {        
	{ "FRZL_RADIO_HELP", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " para esconder.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ para ~g~ligar~s~ radio.~n~~" .. radioConfig.Controls.Decrease.Name .. "~ ou ~" .. radioConfig.Controls.Increase.Name .. "~ para mudar de Frequência~n~~" .. radioConfig.Controls.Input.Name .. "~ para escolher Frequência~n~~" .. radioConfig.Controls.ToggleClicks.Name .. "~ para ~a~ mic clicks~n~Frequência: ~1~ MHz" },
	{ "FRZL_RADIO_HELP2", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " para esconder.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ para ~r~desligar~s~ radio.~n~~" .. radioConfig.Controls.Broadcast.Name .. "~ para falar.~n~Frequência: ~1~ MHz" },
	{ "FRZL_RADIO_INPUT", "Insere um frequência" },
}
Radio.Commands = {
	{
